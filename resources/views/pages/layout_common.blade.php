    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              ...
              <?php if($customer_id ==NULL && $shipping_id==NULL){?>
                <li class="list-inline-item"><a href="{{URL::to('/loginCheck')}}" data-toggle="modal" data-target="#login-modal">Login</a></li>
                <?php }if($customer_id !=NULL && $shipping_id==NULL){?>

                <li class="list-inline-item"><a href="{{URL::to('/checkout')}}">Checkout</a></li>
                <?php }if($customer_id !=NULL && $shipping_id!=NULL){?>
                <li class="list-inline-item"><a href="{{URL::to('/payment')}}">Checkout</a></li>
                <?php }?>  
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="{{url('/home')}}" class="navbar-brand home"><img src="{{URL::to('frontend/img/mainlogo.png')}}" alt="" class="d-none d-md-inline-block"><img src="{{URL::to('frontend/img/mainlogo.png')}}" alt="" class="d-inline-block d-md-none"><span class="sr-only">Perfect Choice</span></a>
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-6 col-lg-6">
                        ...
                        <h5>Clothing</h5>
                        <ul class="list-unstyled mb-3">
                          <li class="nav-item"><a href="category.html" class="nav-link">Dress</a></li>
                          <li class="nav-item"><a href="category.html" class="nav-link">Tops</a></li>
                          <li class="nav-item"><a href="category.html" class="nav-link">Pants</a></li>
                          <li class="nav-item"><a href="category.html" class="nav-link">Accessories</a></li>
                        </ul>
                      </div>
